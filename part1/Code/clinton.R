...
tw = twitteR::searchTwitter('#clinton', n =4000 , since = '2019-01-01')
...
write.table(df,"/home/shikhar/Desktop/CS Books/SecondSem/Data Intensive Comp/lab 2/Data Collection P1/TwitterCSV/clinton.csv", sep = ",", col.names = F, append = T)
