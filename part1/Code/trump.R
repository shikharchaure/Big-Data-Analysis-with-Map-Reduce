...
tw = twitteR::searchTwitter('#trump+#donaldtrump', n =4000 , since = '2019-01-01')
...
write.table(df,"/home/shikhar/Desktop/CS Books/SecondSem/Data Intensive Comp/lab 2/Data Collection P1/TwitterCSV/trump.csv", sep = ",", col.names = F, append = T)
